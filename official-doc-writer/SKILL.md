...
| 字体名称       | 用途         | 文件名          | 是否必需 |
| ---------- | ---------- | ------------ | ---- |
| 方正小标宋\_GBK | 发文机关标志、标题  | FZXBSJW\.TTF | 是    |
| 仿宋\_GB2312 | 正文、发文字号    | SIMFANG.TTF  | 是    |
| 黑体         | 一级标题、密级    | SIMHEI.TTF   | 是    |
| 楷体\_GB2312 | 二级标题、签发人姓名 | SIMKAI.TTF   | 是    |
| 宋体         | 页码         | SIMSUN.TTF   | 是    |
...
- `SIMFANG.TTF`（仿宋\_GB2312）
- `SIMHEI.TTF`（黑体）
- `SIMKAI.TTF`（楷体\_GB2312）
- `SIMSUN.TTF`（宋体）
